...
const Sidebar: React.FC = () => {
  ...
  return (
    <div
      className="h-screen w-1/6 p-6 flex flex-col border-r"
            ...
            <li key={item.path}>
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-md transition-colors font-worksans ${
                  isActive ? "bg-sky-light text-brand-blue" : " black"
                }`}
              >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 w-full">
          <div className="flex items-center gap-2">
            ...
            <div className="text-center md:text-left">
              <p className="text-sm font-normal text-black font-worksans">
                Andy Samberg
              </p>
